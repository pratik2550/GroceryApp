...
public class EditProductActivity extends AppCompatActivity {
    ...
    private void loadProductDetails() {
        ...
        ref.child(mAuth.getUid()).child("Products").child(productId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        titleEt.setText(prductTitle);
                        descriptionEt.setText(prductDescription);
                        categoryTv.setText(prductCategory);
                        discountPercentEt.setText(discountPercent);
                        discountPriceEt.setText(discountPrice);
                        priceEt.setText(orignalPrice);
                        quantityEt.setText(prductQuantity);
